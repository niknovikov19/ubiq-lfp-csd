function [startinglowfreq,endinglowfreq,startinghighfreq,endinghighfreq,goodnessvalue,superficialchannel,deepchannel,highfreqmaxchannel,lowfreqmaxchannel,crossoverchannel] = FLIPAnalysis(nonnormpowmat,laminaraxis,freqaxis,setfreqbool)
% arguments
...
%     % set default values if not passed by user
    alphafreqrange = [10 30];
    gammafreqrange = [50 150];
